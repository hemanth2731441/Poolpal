    ...
    <div class="vehicle-selection">
        <div class="container">
            ...
            <div class="vehicle-grid">
                <a href="login.php" class="vehicle-option" style="animation-delay: 0.1s">
                    <img src="images/vehicle/bikes.png" alt="Bike">
                    <span>Bike</span>
                </a>
                <a href="login.php" class="vehicle-option" style="animation-delay: 0.3s">
                    <img src="images/vehicle/auto.png" alt="Auto" style="width: 60%; height: 60%;">
                    <span>Auto</span>
                </a>
                <a href="login.php" class="vehicle-option" style="animation-delay: 0.2s">
                    <img src="images/vehicle/car.png" alt="Car">
                    <span>Car</span>
                </a>
                <a href="login.php" class="vehicle-option" style="animation-delay: 0.4s">
                    <img src="images/vehicle/bus.png" alt="Bus">
                    <span>Bus</span>
                </a>
                <a href="login.php" class="vehicle-option" style="animation-delay: 0.5s">
