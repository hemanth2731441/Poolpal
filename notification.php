    ...
    <div class="notification-card">
      <div class="section">
        ...
        <div class="alert-item" data-aos="fade-up">
          ...
          <div class="toggle-switch">
            <input type="checkbox" id="trip-updates" class="toggle-input">
        ...
        <div class="alert-item" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="toggle-switch">
            <input type="checkbox" id="account-activity" class="toggle-input">
      ...
      <div class="section">
        ...
        <div class="alert-item" data-aos="fade-up">
          ...
          <div class="toggle-switch">
            <input type="checkbox" id="ride-reminders" class="toggle-input">
        ...
        <div class="alert-item" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="toggle-switch">
            <input type="checkbox" id="driver-messages" class="toggle-input">
        ...
        <div class="alert-item" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="toggle-switch">
            <input type="checkbox" id="system-announcements" class="toggle-input">
